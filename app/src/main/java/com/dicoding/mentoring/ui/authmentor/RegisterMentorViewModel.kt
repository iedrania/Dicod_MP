...
class RegisterMentorViewModel(private val auth: FirebaseAuth) : ViewModel() {
    ...
    fun postRegister(name: String, email: String, password: String) {
        ...
        val client = ApiConfig.getApiService().postRegisterMentor(name, email, password)
        client.enqueue(object : Callback<RegisterResponse> {
            override fun onResponse(
                ...
                if (response.isSuccessful && responseBody != null) {
                    ...
                    Log.e(TAG, "postRegisterMentor onError: $errorMessage")
                }
            }
            ...
            override fun onFailure(call: Call<RegisterResponse>, t: Throwable) {
                _isLoading.value = false
                _isError.value = true
                Log.e(TAG, "postRegisterMentor onFailure: ${t.message}")
            }
        })
    }

    companion object {
        private const val TAG = "RegisterMentorViewModel"
    }
}